...
#>  [1] compiler_4.0.2    magrittr_2.0.2    cli_3.2.0         tools_4.0.2      
#>  [5] htmltools_0.5.1.1 rstudioapi_0.13   yaml_2.2.1        stringi_1.7.6    
#>  [9] rmarkdown_2.9     knitr_1.37        stringr_1.4.0     xfun_0.29        
#> [13] digest_0.6.29     rlang_1.0.1       evaluate_0.14
```
