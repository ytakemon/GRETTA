...
save(CCLE_exp_annot, file = paste0(GRETTA_dir_23Q2, "CCLE_exp_annot.rda"))
save(CCLE_exp, file = paste0(GRETTA_dir_23Q2, "CCLE_exp.rda"))
save(copy_num_annot, file = paste0(GRETTA_dir_23Q2, "copy_num_annot.rda"))
save(copy_num, file = paste0(GRETTA_dir_23Q2, "copy_num.rda"))
save(dep_annot, file = paste0(GRETTA_dir_23Q2, "dep_annot.rda"))
save(dep, file = paste0(GRETTA_dir_23Q2, "dep.rda"))
save(essential_genes, file = paste0(GRETTA_dir_23Q2, "essential_genes.rda"))
save(gene_effect, file = paste0(GRETTA_dir_23Q2, "gene_effect.rda"))
save(mut_calls, file = paste0(GRETTA_dir_23Q2, "mut_calls.rda"))
save(nonessential_genes, file = paste0(GRETTA_dir_23Q2, "nonessential_genes.rda"))
save(protein_annot, file = paste0(GRETTA_dir_23Q2, "protein_annot.rda"))
save(protein_nodup, file = paste0(GRETTA_dir_23Q2, "protein_nodup.rda"))
save(protein, file = paste0(GRETTA_dir_23Q2, "protein.rda"))
save(sample_annot, file = paste0(GRETTA_dir_23Q2, "sample_annot.rda"))